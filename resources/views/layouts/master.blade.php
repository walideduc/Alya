    ...
    <div class="container">
        <div class="row">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="{{url('auth/register')}}"><span class="glyphicon glyphicon-user"></span> Mon compte</a></li>
            </ul>
        </div>
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="{{route('order_cart')}}">Panier</a></li>
...
<script src="{{asset('js/alyya/addProductToCart.js')}}"></script>
</body>
</html>