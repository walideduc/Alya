...
class CreateAmazonCompetitorsLowestOffers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('amazon_competitors_lowest_offers', function (Blueprint $table) {
            $table->increments('id');
...
//            $table->string('status');
    ...
    {
        Schema::drop('amazon_competitors_lowest_offers');
    }
}
