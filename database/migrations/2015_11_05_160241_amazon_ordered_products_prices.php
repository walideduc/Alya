...
class AmazonOrderedProductsPrices extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('amazon_ordered_products_prices', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        //Schema::drop('amazon_ordered_products_prices');
    }
}
